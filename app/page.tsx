...
export default async function Page() {
 ...
 return (
  <main className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50">
    ...
    {/* content */}
    <div className="relative mx-auto w-full max-w-2xl px-5 py-10">
      
      {/* header glass effect */}
      <header className="mb-8 rounded-2xl border border-white/40 bg-white/60 backdrop-blur-xl p-5 shadow-sm">
